...
**2. `st.cache_data.clear()` сносит ВСЕ кэши, а не свой.** Десять вызовов
(`settings` ×2, `methodology` ×5, `matrix_setup` ×2, `seo`). После
сохранения одной настройки заново читаются каталог, диагнозы, экономика,
SQP и трёхмегабайтные шаблоны flat file. У каждой закэшированной функции
есть собственный `.clear()`.
